 ...
 * @author Blackmage
 */
public class TelaGerenciamentoAlunos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblInst.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "E-MAIL", "NOME", "DATA DE NASCIMENTO"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGerenciamentoAlunos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaGerenciamentoAlunos tela = new TelaGerenciamentoAlunos();
